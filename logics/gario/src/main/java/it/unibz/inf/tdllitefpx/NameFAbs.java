...
public class NameFAbs {
	...
	public ABox getABox() {
		...
		ABoxRoleAssertion a4 = new ABoxRoleAssertion(Name, "A", "Marc", 1);//t=1;
		ABoxRoleAssertion a5 = new ABoxRoleAssertion(Name, "B", "Pipo", 1);//t=1;
		ABoxRoleAssertion a6 = new ABoxRoleAssertion(Name, "C", "Charles", 1);//t=1;
